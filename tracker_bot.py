...
def helius_webhook():
    ...
    print("[DEBUG] Payload Helius:", json.dumps(data,indent=2))

    # Forcer events en liste
    ...
    for event in events:
        try:
            ...
            print("[DEBUG] Message à envoyer:", message)

            # Envoie à tous les abonnés
            for cid_list in subs.values():
                for cid in cid_list:
...
if __name__=="__main__":
    print("🚀 Bot Solana + Telegram prêt")
