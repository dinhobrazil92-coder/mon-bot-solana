...
def send_message(chat_id, text):
    try:
        ...
        print(f"[DEBUG] Message envoyé à {chat_id}: {r.status_code}")
    except Exception as e:
        print(f"[DEBUG] Erreur envoi Telegram: {e}")
...
def helius_webhook():
    ...
    print("[DEBUG] Webhook reçu :", json.dumps(data, indent=2))

    # Détecte les events Helius
...
if __name__ == "__main__":
    print("🚀 Bot Telegram + Helius prêt")
